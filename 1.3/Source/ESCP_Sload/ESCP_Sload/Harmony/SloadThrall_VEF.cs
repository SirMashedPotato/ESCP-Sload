...
namespace ESCP_Sload
{
    ...
    class VEF_CompAnimalProduct_Active_Patch
    {
        ...
        {
            if (SloadUtility.PawnIsThrall(__instance.parent as Pawn) && ModSettingsUtility_SloadThralls.ESCP_RaceTools_SloadThrallVEF_AnimalProducts())
            {
                __result = false;
                return false;
            }
    ...
    public static class VEF_CompAsexualReproduction_CompTick_Patch
    {
        ...
        {
            if (SloadUtility.PawnIsThrall(__instance.parent as Pawn) && ModSettingsUtility_SloadThralls.ESCP_RaceTools_SloadThrallVEF_AsexualReproduction())
            {
                return false;
            }
            return true;
