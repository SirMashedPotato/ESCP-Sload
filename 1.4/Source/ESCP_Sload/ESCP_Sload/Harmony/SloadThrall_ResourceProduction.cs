...
namespace ESCP_Sload
{
    ...
    class CompMilkable_Active_Patch
    {
        ...
        {
            if (ESCP_Sload_ModSettings.SloadThrallMilkable && SloadUtility.PawnIsThrall(__instance.parent as Pawn))
            {
                __result = false;
                return false;
            }
    ...
    class CompShearable_Active_Patch
    {
        ...
        {
            if (ESCP_Sload_ModSettings.SloadThrallShearable && SloadUtility.PawnIsThrall(__instance.parent as Pawn))
            {
                __result = false;
                return false;
            }
    ...
    class CompEggLayer_Active_Patch
    {
        ...
        {
            if (ESCP_Sload_ModSettings.SloadThrallEggLaying && SloadUtility.PawnIsThrall(__instance.parent as Pawn))
            {
                __result = false;
                return false;
            }
